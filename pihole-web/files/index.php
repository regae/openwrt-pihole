...
$adm_email = uci_get("pihole", "@pihole[0]", "admin_email");

$svPasswd = isset($pwd);
$svEmail = (isset($adm_email) && filter_var($adm_email, FILTER_VALIDATE_EMAIL)) ? $adm_email : "";
...
$gravityDBFile = uci_get("pihole", "@pihole[0]", "gravitydb");
if (!isset($gravityDBFile)) {
